...
@Component({
  selector: 'app-ion-regional-overview',
  templateUrl: './ion-regional-overview.component.html',
  styleUrls: ['./ion-regional-overview.component.css']
})
export class IonRegionalOverviewComponent implements OnInit{
