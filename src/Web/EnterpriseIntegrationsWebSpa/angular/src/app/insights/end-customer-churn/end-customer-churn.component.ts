...
@Component({
  selector: 'app-end-customer-churn',
  templateUrl: './end-customer-churn.component.html',
  styleUrls: ['./end-customer-churn.component.css']
})
export class EndCustomerChurnComponent implements OnInit {
